...
#load G4-SNPs files
snvs <- read.delim("path_to_your_file/G4_SNVs.txt", header = TRUE) #load pqsfinder or G4Hunter G4-SNV files

#filter for delta pqsfinder score >10
df <- snvs[snvs$score.difference > 10, ]
